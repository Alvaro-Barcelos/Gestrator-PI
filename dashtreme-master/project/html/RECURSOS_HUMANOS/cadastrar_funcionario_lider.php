         ...
         <div class="card">
           ...
           <hr>
            <form method="post" action="../../php/cadastrar_funcionario.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <div class="form-group">
                      <!-- Currículo -->
                        ...
                        <input type="file" class="select-style" name="curriculo_funcionario" id="curriculo" accept="application/pdf" required onchange="handleFileUpload(event, 'pdf-icon')" />
                    </div>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-light px-5"> Registrar</button>
              </div>
            </form>
         </div>
         </div>
