<?php
    ...
    $criar_funionario = mysqli_query($conexao, "INSERT INTO funcionario(nome_funcionario, nacionalidade, data_nascimento,cargo, salario, cpf, rg, email, celular, cidade, endereco, pcd, foto_funcionario, id_setor, id_login) 
