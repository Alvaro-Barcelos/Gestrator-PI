          ...
          <div class="card">
            ...
            <div class="form-group">
              <div class="custom-dropdown">
                <input type="hidden" name="setor" value="6">
                ...
                <div class="form-group">
                  ...
                  <div class="custom-dropdown">
                    <select id="input-2" class="form-control" name="prioridade">
                      ...
                      <option value="Alta">Alta</option>    <!-- Acrescentei novas class e um css la no app-style, para que o options fique da forma correta -->
